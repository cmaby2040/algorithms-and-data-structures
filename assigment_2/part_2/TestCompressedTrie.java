...
public class TestCompressedTrie {
    ...
    public static void Test1()
    {
        ...
        System.out.println("\nTest1 results:");
        MyCompressedTrie2 compTree= new MyCompressedTrie2(tree);
        int nod = 0;
        int counter = 0;
    ...
    public static void Test2()
    {
        ...
        System.out.println("\nTest2 results:");
        MyCompressedTrie2 compTree= new MyCompressedTrie2(tree);//should compress like this: (000)->(1)->(010)->(1)
        int nod = 0;
        int counter = 0;
        System.out.println("Number of Nodes in the compressed Trie: " + (nod = compTree.numNodes()));
        if(nod != 2)
    ...
    public static void Test3()
    {
        ...
        int t = 300;
        Random r = new Random();
        MyCompressedTrie2 cmpTree = new MyCompressedTrie2();
        while(t-->0)
        {
            ...
            cmpTree = new MyCompressedTrie2(tree);
